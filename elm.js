...
var $author$project$Login$buildErrorMessage = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
...
var $author$project$Login$Token = function (token) {
	return {token: token};
};
...
var $author$project$Login$tokenDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'token',
	$elm$json$Json$Decode$string,
	$elm$json$Json$Decode$succeed($author$project$Login$Token));
var $author$project$Login$submitLogin = function (credentials) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Login$credentialsEncoder(credentials)),
			expect: A2($elm$http$Http$expectJson, $author$project$Login$LoginDone, $author$project$Login$tokenDecoder),
...
var $author$project$Login$validEmail = A2(
...
var $author$project$Login$sumOfErrors = function (model) {
	...
	var isEmailValid = A2($elm$regex$Regex$contains, $author$project$Login$validEmail, model.loginCredentials.email);
							...
							model,
							{
								errors: A2(
									...
									$author$project$Login$BadRequest(
										$author$project$Login$buildErrorMessage(error)),
									model.errors)
							}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Signup$Token = function (token) {
	return {token: token};
};
var $author$project$Signup$tokenDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'token',
	$elm$json$Json$Decode$string,
	$elm$json$Json$Decode$succeed($author$project$Signup$Token));
var $author$project$Signup$submitSignup = function (credentials) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Signup$credentialsEncoder(credentials)),
			expect: A2($elm$http$Http$expectJson, $author$project$Signup$SignupDone, $author$project$Signup$tokenDecoder),
...
var $author$project$Signup$validEmail = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	A2(
		$elm$regex$Regex$fromStringWith,
...
var $author$project$Signup$sumOfErrors = function (model) {
	...
	var isEmailValid = A2($elm$regex$Regex$contains, $author$project$Signup$validEmail, model.signupCredentials.email);
			...
			case 'SignupSubmit':
				...
				return $elm$core$List$isEmpty(errorsList) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{errors: _List_Nil}),
					$author$project$Signup$submitSignup(model.signupCredentials)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{errors: errorsList}),
					$elm$core$Platform$Cmd$none);
							...
							model,
							{
								errors: A2(
									...
									$author$project$Signup$BadRequest(
										$author$project$Signup$buildErrorMessage(error)),
									model.errors)
							}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ChangedUrl':
				var url = msg.a;
				var newPage = $author$project$Main$urlToPage(url);
				return $author$project$Main$initCurrentPage(
					_Utils_Tuple2(
						_Utils_update(
							model,
			...
			default:
				...
				var _v4 = model.page;
				if (_v4.$ === 'SignupPage') {
					var signupModel = _v4.a;
					var _v5 = A2($author$project$Signup$update, signupMsg, signupModel);
					var signupModelFromSignup = _v5.a;
					var signupMsgFromSignup = _v5.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onInput($author$project$Login$StoreEmail),
										$elm$html$Html$Attributes$value(model.loginCredentials.email)
									]),
								_List_Nil)
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Events$onInput($author$project$Login$StorePassword),
										$elm$html$Html$Attributes$value(model.loginCredentials.password)
									]),
								_List_Nil)
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('text'),
										$elm$html$Html$Events$onInput($author$project$Signup$StoreEmail),
										$elm$html$Html$Attributes$value(model.signupCredentials.email)
									]),
								_List_Nil)
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onInput($author$project$Signup$StorePassword),
										$elm$html$Html$Attributes$value(model.signupCredentials.password)
									]),
								_List_Nil)
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('password'),
										$elm$html$Html$Events$onInput($author$project$Signup$StoreConfirmPassword),
										$elm$html$Html$Attributes$value(model.signupCredentials.confirmPassword)
									]),
								_List_Nil)
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
...
var $author$project$Main$exampleTree = A3(
	$author$project$Main$Node,
	4,
	A3($author$project$Main$Node, 1, $author$project$Main$Empty, $author$project$Main$Empty),
	A3($author$project$Main$Node, 9, $author$project$Main$Empty, $author$project$Main$Empty));
var $elm$html$Html$footer = _VirtualDom_node('footer');
var $author$project$Main$insert = F2(
	function (target, tree) {
		if (tree.$ === 'Empty') {
			return A3($author$project$Main$Node, target, $author$project$Main$Empty, $author$project$Main$Empty);
		} else {
			var value = tree.a;
			var left = tree.b;
			var right = tree.c;
			return (_Utils_cmp(target, value) < 0) ? A3(
				$author$project$Main$Node,
				value,
				A2($author$project$Main$insert, target, left),
				right) : ((_Utils_cmp(target, value) > 0) ? A3(
				$author$project$Main$Node,
				value,
				left,
				A2($author$project$Main$insert, target, right)) : tree);
		}
	});
var $author$project$Main$lengthHelper = F2(
	function (list, lengthSoFar) {
		if (!list.b) {
			return 0;
		} else {
			var rest = list.b;
			return A2($author$project$Main$lengthHelper, rest, lengthSoFar) + 1;
		}
	});
var $author$project$Main$length = function (list) {
	return A2($author$project$Main$lengthHelper, list, 0);
};
var $author$project$Main$sumHelper = F2(
	function (list, sumSoFar) {
		if (!list.b) {
			return 0;
		} else {
			var first = list.a;
			var rest = list.b;
			return A2($author$project$Main$sumHelper, rest, first) + sumSoFar;
		}
	});
var $author$project$Main$sum = function (list) {
	return A2($author$project$Main$sumHelper, list, 0);
};
			...
			_List_fromArray(
				[
					...
					$elm$core$Debug$toString(
						A2($author$project$Main$insert, 2, $author$project$Main$exampleTree)))
				]))
		]));
